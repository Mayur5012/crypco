...
class Crypnews extends React.Component {
    constructor(props) {
      super(props);
    ...
    //   console.log("i am coponentdidmount");
      let res = await fetch(
        // `https://newsapi.org/v2/everything?q=${this.props.newsName}&apiKey=pub_971276214e880f4c95ce1cc91e1885ce7699`
        `https://newsapi.org/v2/top-headlines?category=crypto&apiKey=pub_971276214e880f4c95ce1cc91e1885ce7699`
      );
